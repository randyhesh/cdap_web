...
<body>
	...
	<a href="index.jsp" class="logo"><img
		src="uploads/projectHeader2.PNG" style="width: 1497px;margin-left: -94px;height: 58px;margin-top: 46px;"></a>
	...
	<div class="row">
		...
		src="uploads/createProjectIcon.png" style="margin-left: 611px;;"></a>
			
			
			<a href="algorithmSelection.jsp" class="logo"><img
		src="uploads/malwareProject.PNG" style="width: 1448px;margin-left: -53px;height: 213px;margin-top: 64px;"></a>
